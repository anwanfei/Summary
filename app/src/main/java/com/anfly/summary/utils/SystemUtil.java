...
public class SystemUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) SummaryApplication.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static int dp2px(float dpValue) {
        final float scale = SummaryApplication.getApp().getResources().getDisplayMetrics().density;
        return (int) (dpValue * scale + 0.5f);
    }
