...
import com.anxin.anfly.base.AnflyApplication;
 ...
 * @author Anfly
 * @date 2019/3/5.
 * description：异常崩溃处理类:当程序发生未处理异常时，该类将版本号，版本名，设备号，Android版本，生产信息进行记录日志并发送至服务器。
 */
public class CrashHandler implements Thread.UncaughtExceptionHandler{
    private Thread.UncaughtExceptionHandler exceptionHandler;
    private AnflyApplication myApp;
    /** 错误日志保存名称 */
    private Map<String, String> infos = new HashMap<>();
    /** 错误日志文件名 */
    private final String LOGFILE_NAME = FileUtils.getCacheDir() + "crash.txt";

    public CrashHandler(AnflyApplication myApp){
    ...
    private void saveCrashInfoToFile(Throwable ex) {
        ...
        try {
            ...
            writer.write("创建时间：" + StrUtil.currentTime("yy-MM-dd hh:mm:ss").toString()+lineFeed+lineFeed);
